...
public class Flock : MonoBehaviour {
    ...
    void Update() {
        ...
        //Bounds b = myManager.GetFlockBouds();
        ...
        } else if (Physics.Raycast(transform.position, this.transform.forward * rangeOfSight, out hit)) {

            turning = true;
            
            direction = Vector3.Reflect(this.transform.forward, hit.normal);
            Debug.DrawRay(this.transform.position, direction * rangeOfSight, Color.green);
            Debug.DrawRay(this.transform.position, this.transform.forward * rangeOfSight, Color.red);
        } else {
